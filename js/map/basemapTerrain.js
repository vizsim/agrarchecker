...
//
// Basemap-/Terrain-Handling OHNE API-Key (1:1 übernommen aus vizsim/nettobreite).
//   - Basis ist der gehostete OpenFreeMap-Positron-Style (Vektorquelle "openmaptiles").
//   - Raster-Basemaps OSM Carto + Esri World Imagery werden als Layer ein-/ausgeblendet.
//   - Geländerelief (3D-Terrain + Hillshade zusammen) via Mapterhorn (raster-dem,
//     terrarium), 3D-Gebäude via OpenFreeMap-Planet — alles keyless.
//
// Beim Wechsel auf eine Raster-Basemap werden NUR die Host-Style-Layer
// (source === "openmaptiles" + Hintergrund) versteckt. Die Daten-Layer von
// agrarchecker (agrar_vector_*, agrar_raster_*, mapillary-*) nutzen andere
// Sources und bleiben dadurch sichtbar.
...
// Geländerelief: 3D-Terrain + Hillshade zusammen
